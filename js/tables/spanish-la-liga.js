...
const MP = ["MP", 19, 19, 20, 19, 19, 20, 20, 20, 19, 19, 19, 19, 20, 20, 20, 20, 20, 19, 20, 19];
const MW = ["MW", 15, 15, 12, 12, 12, 8, 7, 8, 6, 7, 5, 6, 5, 3, 5, 3, 3, 2, 2, 0];
const MD = ["MD", 3, 3, 5, 5, 2, 8, 10, 4, 8, 5, 8, 4, 5, 10, 4, 8, 7, 9, 5, 5];
const GF = ["GF", 40, 46, 38, 36, 39, 31, 22, 19, 24, 22, 18, 22, 18, 18, 27, 21, 25, 14, 22, 19];
const GA = ["GA", 11, 24, 20, 22, 23, 21, 20, 17, 25, 23, 24, 29, 27, 24, 41, 30, 30, 26, 41, 43];
...
let teams = ["Teams", "Real Madrid", "Girona", "Barcelona", "Athletic Club", "Athletico Madrid", "Real Sociedad",
 "Real Betis", "Getafe", "Valencia", "Las Palmas", "Rayo Vallecano", "Osasuna", "Alaves", 
 "Villarreal", "Mallorca", "Sevilla", "Celta Vigo", "Cadiz", "Granada", "Almeria"];
