...
const MW = ["MW", 16, 15, 13, 10, 10, 10, 8, 9, 8, 7, 6, 5, 4, 5, 5, 2, 4, 4, 3, 2];
const MD = ["MD", 3, 4, 3, 4, 3, 3, 8, 4, 5, 7, 7, 7, 9, 4, 4, 12, 6, 5, 4, 6  ];
const GF = ["GF", 49, 32, 38, 29, 35, 24, 23, 30, 32, 18, 20, 20, 20, 26, 25, 21, 19, 18, 11, 17];
const GA = ["GA", 10, 12, 21, 21, 21, 20, 18, 25, 24, 18, 25, 24, 26, 36, 39, 32, 33, 27, 35, 40];
...
let teams = ["Teams", "Inter", "Juventus", "AC Milan", "Fiorentina", "Atalanta", "Lazio",
 "Bologna", "Napoli", "Burgos", "AS Roma", "Torino", "Monza", "Genoa", 
 "Leece", "Sassuolo", "Frisonone", "Udinese", "Cagliari", "Verona", "Empoli"];
