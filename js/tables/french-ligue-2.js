...
const MP = ["MP", 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20];
const MW = ["MW", 12, 12, 9, 10, 8, 8, 8, 9, 8, 8, 8, 7, 6, 5, 6, 6, 4, 3, 3, 1];
const MD = ["MD", 5, 4, 8, 5, 7, 6, 6, 3, 6, 5, 5, 7, 6, 8, 5, 4, 7, 8, 5, 8 ];
const GF = ["GF", 43, 33, 27, 21, 34, 25, 32, 25, 21, 28, 20, 17, 23, 24, 21, 18, 22, 25, 15, 11 ];
const GA = ["GA", 21, 18, 19, 17, 32, 17, 29, 23, 21, 25, 20, 20, 23, 25, 28, 27, 29, 30, 34, 27];
...
let teams = ["Teams", "Auxerre", "Angers", "Grenoble Foot", "Laval", "Pau", "Guingamp",
 "Rodez", "Paris", "Ajaccio", "Caen", "St. Etienne", "Amiens", "Bastia", 
 "Troyes", "Bordeaux", "Concarneau", "Annecy", "Quevilly-Rouen", "Dunkerque", "Valenciennes"];
