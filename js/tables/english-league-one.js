...
const MP = ["MP", 26, 24, 25, 25, 25, 24, 25, 26, 25, 24, 26, 25, 25, 25, 26, 25, 26, 25, 24, 25, 25, 25, 26, 25];
const MW = ["MW", 15, 16, 14, 15, 14, 12, 12, 11, 11, 9, 8, 8, 7, 8, 9, 7, 7, 10, 7, 7, 7, 6, 4, 4];
const MD = ["MD", 8, 3, 7, 4, 4, 7, 7, 6, 3, 7, 8, 8, 9, 6, 3, 8, 7, 5, 6, 5, 6, 5, 8, 6];
const GF = ["GF", 42, 45, 50, 47, 42, 46, 37, 42, 31, 34, 29, 25, 39, 28, 17, 29, 21, 35, 21, 18, 34, 19, 21, 22];
const GA = ["GA", 22, 24, 27, 24, 29, 28, 25, 32, 33, 33, 29, 31, 37, 38, 36, 34, 35, 30, 32, 37, 41, 34, 38, 45];
