...
const MP = ["MP", 27, 27, 27, 27, 27, 27, 27, 27, 27, 27, 27, 27, 27, 27, 27, 27, 27, 27, 27, 27, 27, 27, 27, 27];
const MW = ["MW", 21, 17, 16, 15, 13, 10, 12, 10, 11, 12, 11, 11, 11, 10, 8, 8, 8, 10, 7, 7, 5, 6, 5, 3];
const MD = ["MD", 2, 7, 7, 6, 6, 10, 4, 9, 6, 3, 5, 5, 4, 6, 9, 8, 8, 2, 9, 8, 11, 4, 6, 9 ];
const GF = ["GF", 55, 50, 50, 48, 40, 41, 37, 44, 41, 41, 44, 33, 34, 30, 37, 29, 26, 40, 44, 32, 27, 21, 22, 24];
const GA = ["GA", 21, 34, 31, 25, 25, 29, 30, 37, 78, 40, 43, 44, 36, 30, 41, 34, 32, 52, 46, 43, 45, 44, 39, 51];
...
let teams = ["Teams", "Leicester", "Ipswich", "Southampton", "Leeds", "West Brom", "Sunderland",
 "Hull", "Coventry", "Cardiff", "Watford", "Bristol", "Middlesbrough", "Norwich", 
 "Preston", "Millwall", "Swansea", "Blackburn", "Plymouth", "Stoke", "Birmingham",
 "Huddesfield", "Sheffield Wednesday", "QPR", "Rotherham"];
