...
const MP = ["MP", 20, 20, 21, 21, 21, 20, 20, 20, 20, 20, 20, 19, 21, 20, 20, 20, 21, 20, 21, 20];
const MW = ["MW", 13, 13, 13, 13, 12, 10, 10, 8, 9, 9, 8, 7, 7, 5, 5, 6, 8, 4, 3, 2];
const MD = ["MD", 6, 4, 4, 4, 4, 4, 2, 7, 4, 2, 4, 4, 3, 6, 5, 4, 3, 4, 3, 3];
const GF = ["GF", 43, 48, 42, 43, 44, 33, 24, 38, 35, 41, 30, 28, 28, 22, 24, 29, 24, 24, 21, 15];
const GA = ["GA", 18, 23, 27, 27, 31, 30, 29, 33, 31, 32, 31, 35, 36, 29, 35, 33, 28, 38, 42, 49];
...
let teams = ["Teams", "Liverpool", "Manchester City", "Arsenal", "Aston Villa", "Tottenham", "West Ham",
 "Manchester United", "Brighton", "Chelsea", "Newcastle", "Wolves", "Bournemouth", "Fulham", 
 "Crystal Palace", "Nottingham", "Brentford", "Everton", "Luton", "Burnley", "Sheffield United"];
