...
const MW = ["MW", 12, 11, 11, 10, 10, 10, 9, 7, 7, 5, 5, 6, 7, 5, 5, 5, 4, 4, 3, 3];
const MD = ["MD", 6, 5, 5, 6, 5, 3, 5, 7, 7, 11, 9, 5, 4, 8, 6, 5, 6, 6, 8, 5  ];
const GF = ["GF", 38, 36, 29, 27, 29, 33, 32, 22, 20, 21, 23, 27, 27, 20, 19, 23, 24, 18, 16, 17];
const GA = ["GA", 18, 23, 21, 20, 16, 27, 25, 21, 24, 21, 26, 28, 30, 23, 22, 34, 30, 25, 31, 36];
...
let teams = ["Teams", "Parma", "Venezia", "Como", "Cittadella", "Cremonese", "Cantanzaro",
 "Palermo", "Brescia", "Modena", "Bari", "Reggiana", "Sudtirol", "Sampdoria", 
 "Pisa", "Cosenza", "Lecco", "Ternana", "Ascoli", "Spezia", "Feralsipalo"];
